// Shared k6 logic for scalability Bronze / Silver. See docs/scalability-bronze.md, scalability-silver.md
...
export function createScalabilityScenario(defaultBaseUrl) {
